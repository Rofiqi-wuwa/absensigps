...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image = $request->image;
        $folderPath = "public_html/storage/uploads/absensi/";
            ...
            if ($cek > 0) {
                if ($jam_pulang < $jamkerja_pulang) {
                    ...
                    if ($update) {
                        ...
                        $message_text = "Saya".$no_hp = $datakaryawan->nama_lengkap."Telah melakukan absensi pulang pada jam".$jam;
                        $secret_token = "8061655438:AAEceIiOuoRIO6Z41e8yFOg7VqmYw5-RWUg";

                        $url = "https://api.telegram.org/bot" . $secret_token . "/sendMessage?parse_mode=markdown&chat_id=6002094179";
                ...
                if ($jam < $jamkerja->awal_jam_masuk) {
                    ...
                    if ($simpan) {
                        echo "success|Terimkasih, Selamat Mengajar|in";

                        $message_text = "Saya".$no_hp = $datakaryawan->nama_lengkap."Telah melakukan absensi masuk pada jam".$jam;
                        $secret_token = "8061655438:AAEceIiOuoRIO6Z41e8yFOg7VqmYw5-RWUg";
